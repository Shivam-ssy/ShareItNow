        ...
        e.preventDefault();
          ...
          if(response.data){
            ...
            if(response.data){
              ...
              alert("Something went Wrong or Duplicate email")
            }
    ...
    return(
       ...
       <div className="flex justify-center w-full h-screen items-center px-3">
        ...
        <form onSubmit={handleSubmit} className="flex justify-center items-center flex-col gap-2">
            ...
            <input type="name" name="name" id="name" required placeholder="Full Name" value={name} onChange={handleNameChange} className="w-full rounded-xl px-3 py-2 border-slate-300 border-2 "/>
