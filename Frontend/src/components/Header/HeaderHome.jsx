...
import { Link } from "react-router-dom";
  function HeaderHome({name,className}){
     ...
     return (
        <>
        <div className={`flex justify-between items-center bg-gray-900 px-10 py-5 ${className} `}>
          ...
          <div className="flex text-white gap-4 items-center">
           ...
           <Link to="/Home/share/directshare"> <div className="cursor-pointer">Share directly</div></Link>
            <div className="outline-none ms-9 flex items-center gap-2 px-2 py-1 font-bold text-white"><img  width="20px" src="/user-3-fill.svg" alt="" />{name}</div>
